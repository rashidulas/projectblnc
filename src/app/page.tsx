...
export default function Home() {
  ...
  return (
    <main className="bg-white overflow-x-hidden">
      ...
      <section className="bg-white max-w-7xl mx-auto px-6 pt-16 md:pt-20 pb-24 -mt-[50vh]">
      ...
      <section className="bg-white max-w-7xl mx-auto px-6 pt-8 pb-24">
        <h2 className="text-left text-lg md:text-xl font-semibold tracking-tight text-neutral-900 uppercase mb-6 md:mb-8">
          Beyond Fashion
        </h2>
        <p className="text-sm md:text-base text-neutral-600 leading-relaxed w-full mb-10 md:mb-14">
        ...
        <div className="relative w-full aspect-[4/3] md:aspect-[16/10] max-h-[70vh] overflow-hidden">
          <Image
            src="/hod.jpg"
            alt="Beyond Fashion"
            fill
