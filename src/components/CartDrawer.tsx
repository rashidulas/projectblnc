          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-6">
              {cart.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center">
                  ...
                  <p className="text-sm text-neutral-400">Add some items to get started</p>
                </div>
              ) : (
                  ...
                  {cart.map((item) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="p-2 hover:bg-neutral-100 rounded-md transition-colors self-start"
            ...
            {cart.length > 0 && (
              <div className="border-t border-neutral-200 p-6 space-y-4">
                ...
                <button className="w-full bg-black text-white py-4 rounded-md hover:opacity-90 transition-opacity font-medium">
                  Checkout
                </button>
